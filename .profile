...
alias umount_freebox='sudo umount /media/pi/Freebox'
alias mount_gdrive='sudo gdfs -o allow_other /home/pi/Documents/API/gdfs.creds /media/pi/Google_Drive'
alias umount_gdrive='sudo umount /media/pi/Google_Drive'
alias upgrade='sudo apt-get update && sudo apt-get -y upgrade && sudo apt-get -y full-upgrade && sudo apt-get -y dist-upgrade'
